...
const map_default_opacity = 0.8;
const map_highlight_opacity = 1;
const map_background_opacity = 0.35;

const map_highlight_stroke_width = 1;
const map_default_stroke_width = 0.3;
